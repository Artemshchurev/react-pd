...
const Description = () => {
    ...
    return (
        <div>
                ...
                <div className="row">
                    <a href="#" className="col-md-3 margin-bottom-10px" data-toggle="modal" data-target="#faqModal" data-q="q5">
                        <div className="card-col3 d-flex align-items-center justify-content-center">
                            <div className="card-col3-text">Какие потребуются документы?</div>
                        </div>
                    </a>
                    ...
                    <a href="#" className="col-md-3 margin-bottom-10px" data-toggle="modal" data-target="#faqModal" data-q="q7">
                        <div className="card-col3 d-flex align-items-center justify-content-center">
            ...
            <Button outline color="" className="text-primary" onClick={toggle}>
...
const elem = document.querySelector('.debt-collection-collapse')

if (elem) {
    ReactDOM.render(<Description />, elem)
}
